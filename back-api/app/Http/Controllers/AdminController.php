...
class AdminController extends Controller
{
    ...
    public function showLogin()
    {
        ...
        $civicData = cache()->remember('admin-login:civic-data', now()->addMinutes(15), function () {
            return [
        ...
        return view('admin.login', compact('civicData'));
    }
    ...
    private function calculateHoyNoCircula(array $fallback = []): array
    {
        ...
        return $weekdayMap[$dayOfWeek] ?? ($fallback ?: [
            'plates' => 'Consulta',
            'restriction' => 'Revisa la información oficial',
        ]);
    }
}
